...
def single_gpu_test(model,
    ...
    for i, data in enumerate(data_loader):
        ...
        # 剔除这一部分代码，训练过程的可视化放在 dataset.evaluation
        # 测试阶段，统一收集完所有测试结果后，进行 evaluation & visualization
        # if show or out_dir:
...
def multi_gpu_test(model, data_loader, tmpdir=None, gpu_collect=False, training_test=True):
...
# ****************************************************** #
# We modified the original test.py file.
