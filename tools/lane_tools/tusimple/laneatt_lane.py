...
class LaneEval(object):
    ...
    @staticmethod
    def bench_one_submit(pred_file, gt_file, acc_threshold=None):
        try:
        ...
        for i, pred in enumerate(json_pred):
            ...
            fp += p
            fn += n
            if acc_threshold is not None and a < acc_threshold:
                error_lane_indices.append(i)
        num = len(gts)
