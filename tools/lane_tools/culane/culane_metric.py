...
def eval_predictions(pred_dir, anno_dir, list_path, width=30, official=True, sequential=False, full_results=False):
    ...
    if full_results:
        return {'results': results, 'predictions': predictions, 'annotations': annotations}
